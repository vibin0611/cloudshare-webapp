      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-20 text-center lg:py-28">
          ...
          <div className="mt-10 flex justify-center gap-4">
            ...
            <button className="rounded-lg bg-purple-600 px-6 py-3 font-semibold text-white shadow-md transition hover:bg-purple-700">
              Get Started
            </button>

            <button className="rounded-lg border-2 border-purple-600 bg-white px-6 py-3 font-semibold text-purple-600 shadow-md transition hover:bg-purple-50">
              Sign In
            </button>
